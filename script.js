class SolarGamesEngine {
    ...
    // تم تحديث الدالة لربط المؤقت داخل الألعاب مع المؤقت المركزي
    updateGlobalTimerUI() {
        ...
        if(display1) {
            display1.innerText = `${h}:${m}:${s}`;
            display1.style.color = this.timeFrozen ? '#00ccff' : '#fff';
        }
        if(display2) {
            display2.innerText = `${h}:${m}:${s}`;
        }
        if(display3) {
            display3.innerText = `${h}:${m}:${s}`;
            display3.style.color = this.timeFrozen ? '#00ccff' : '#fff';
        }
    }
    ...
    setupStage() {
        ...
        switch(p.uiType) {
            ...
            case 'HARD_COLOR_CODE': { // الباب 19
                ...
                let target = [3, 0, 5, 2, 4]; // Green, Gold, Gray, Blue, White
            ...
            // ================== تعديلاتك الجديدة (5، 8، 9، 10، 16، 18، 22، 23، 24، 26، 28، 30) ==================
            ...
            case 'CAESAR_HARD': { // الباب 16
                ...
                txtDisp16.innerText = 'LJSPWZL'; // +7 shifted ECLIPSE
            ...
            case 'DNA': { // الباب 22 (تم استعادة اللعبة وإصلاحها بالكامل)
            ...
            // ================== الألعاب الأصلية (1 لـ 30) التي لم تتغير ==================
