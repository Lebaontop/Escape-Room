class SolarGamesEngine {
    ...
    buildPuzzles() {
        ...
        for(let i=1; i<=30; i++) {
            ...
            else if(i===21) { m.uiType = 'HARD_LOGIC'; m.desc="قفل النمط الأمني: ارسم النمط السري (Z) عبر العقد بشكل متصل."; m.ans=[0,1,2,4,6,7,8]; m.hint="💡 تفاعلي: ارسم حرف Z. | 📝 كتابي: تخاف من الماء."; }
    ...
    setupStage() {
        ...
        switch(p.uiType) {
            ...
            // ================== الحالات الـ 30 المصممة بدقة كاملة ==================
            ...
            case 'HARD_COLOR_CODE': {
                ...
                let target = [3, 0, 4, 2, 5]; // Green, Gold, White, Blue, Gray
